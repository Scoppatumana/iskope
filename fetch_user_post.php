...
$findId = selectOne('users', ['username'=> $userID]);
$mainUserId = $findId['id'];
$posts = getPostsByUserId(1,$mainUserId,$limit,$offset);
...
foreach ($posts as $key => $post) {
    ...
    <article class="post-card flat-card">
        ...
        <div class="post-info">
            ...
            <a href="t/'.$post['topicName'].'" class="topic-tag td-none">'.$post['topicName'].'</a>
