      ...
      <div class="admin-container">
        <div class="admin-table lg-box">
          ...
          <div class="responsive-table">
            <p>Are you sure you want to delete the post title <strong><?php echo $postTitle ?></strong> Permanently?
            </p>
            <p style="color: red;">This action CANNOT be undone</p>
            <div>
              <a href="confirm-delete.php?del_id=<?php echo $postId ?>" class="btn danger-btn">Permanently Delete</a>
