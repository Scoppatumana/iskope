    ...
    <div class="page-content">
      <div class="admin-container">
        <form action="" method="post" class="admin-form sm-box" enctype="multipart/form-data">
          <h1 class="center">Create Role</h1>
          ...
          <div class="input-group">
            ...
            <textarea name="description" value="<?php echo $description ?>" id="body">
          ...
          <div class="input-group" style="margin-top: 8px">
            ...
            <button class="btn primary-btn small-btn" type="submit" name="add-role">
