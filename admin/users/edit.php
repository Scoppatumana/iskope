      ...
      <div class="admin-container">
        <form action="" method="post" class="admin-form sm-box" enctype="multipart/form-data">
          ...
          <div class="input-group avatar-input-group center">
                <input type="file" name="image" type="text" name="username" id="avatar-input" class="hide avatar-input">
                <button type="button" class="change-avatar-btn" id="change-avatar-btn"
                <?php 
                if($image){
                ?>
                style="background-image: url(../../assets/images/userimages/<?php echo $image ?>); background-size: cover; overflow: hidden;"
                <?php
                }else{
                ?>
          ...
          <div class="input-group">
            ...
            <button class="btn primary-btn small-btn" type="submit" name="update-user">
