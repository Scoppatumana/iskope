      ...
      <div class="admin-container">
        <div class="admin-table lg-box">
          ...
          <div class="responsive-table">
            <p>Are you sure you want to delete the permission <strong><?php echo $permissionname ?></strong> Permanently?
            </p>
            <p style="color: red;">This action CANNOT be undone</p>
            <div>
              <a href="confirm-delete.php?del_id=<?php echo $permissionId ?>" class="btn danger-btn">Permanently Delete</a>
